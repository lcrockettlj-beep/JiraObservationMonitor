...
def main()->Dict[str,Any]:
 ...
 try:
  ...
  names=['admin_enriched_refresh_status.json','users_access_actionable_drilldown_v1.json','named_user_display_identity_v1.json','verified_active_jira_users_v1.json','admin_directory_users.json','project_governance_named_identity_authority_v1.json','project_lead_authority_v1.json']
