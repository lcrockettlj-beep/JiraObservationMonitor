...
# This file must not treat legacy legacy_records as backend or website truth.
...
EXPECTED_NOTE = "Runtime collector was not requested. Status inferred from retired_runtime_contract_marker_json freshness."
